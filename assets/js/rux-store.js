      ...
      <div class="product-card ${isComingSoon ? 'coming-soon-card' : ''}" data-category="${product.category}">
        ...
        <div class="product-card-body">
          ...
          <div class="product-card-footer">
            ...
            ${isComingSoon
              ? `<div class="product-card-actions"><a href="https://wa.me/923006458707?text=Hello%20RUX%20Team%2C%20I%20am%20interested%20in%20pre-ordering%20${encodeURIComponent(product.name)}%20when%20launched" target="_blank" class="btn btn-sm btn-notify-wa" style="background: #0284c7; color: #fff; font-size: 0.72rem; padding: 6px 10px; border-radius: 6px; font-weight: 700; text-decoration: none;" title="Notify Me on WhatsApp">Notify Me</a></div>`
              : `<div class="product-card-actions">
                  <a href="https://wa.me/923006458707?text=Hello%20RUX%20Team%2C%20I%20would%20like%20to%20request%20a%20price%20quote%20for%20${encodeURIComponent(product.name)}" target="_blank" class="btn-quote-wa" title="Request Quote on WhatsApp"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981z"/></svg> Quote</a>
